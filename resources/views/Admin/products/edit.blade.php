        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <!--begin::Form-->
                    <form   class="form d-flex flex-column flex-lg-row"  action="{{ route('products.update',$product->id) }}" method="post" enctype="multipart/form-data">
                        <!--begin::Aside column-->
                        @csrf
                        @method('put')
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body text-center pt-0">
                                    ...
                                    <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
                                        ...
                                        <div class="image-input-wrapper w-150px h-150px" style="background-image: url('{{ $product->image_path}}')"></div>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <select class="form-select mb-2" name="status" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_product_status_select">
                                         ...
                                         <option value="Scheduled" @if($product->status == 'Scheduled' ) selected @endif >Scheduled</option>
                                        ...
                                        <div class="card card-flush py-4">
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div>
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Editor-->
                                                    <textarea name="description" id="" cols="30" rows="5"  class="form-control mb-2" >{{ old('description', $product->description)}}</textarea>
                                                     <!--end::Editor-->
                                                    <!--begin::Description-->
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="row row-cols-1 row-cols-xl-3 row-cols-md-2 border border-dashed rounded pt-3 pb-1 px-2 mb-5 mh-300px overflow-scroll" id="kt_ecommerce_edit_order_selected_products">
                                                    ...
                                                    @foreach ($product->gallaries as $gallary)
                                                        <div class="col my-2" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_25" style="width: 15% !important;">
                                                            <div class="d-flex align-items-center border border-dashed p-3 rounded bg-white">
                                                                <!--begin::Thumbnail-->
                                                                <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="symbol symbol-50px">
                                                                    <span class="symbol-label" style="background-image:url('{{ $gallary->image_url }}');"></span>
                                                                </a>
                                                                <!--end::Thumbnail-->
                                                             </div>
                                                        </div>          
                                        ...
                                        <div class="card card-flush py-4">
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="mb-10 fv-row">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" name="price" class="form-control mb-2" placeholder="Product price" value="{{ old('price', $product->price)}}" />
                                                    <!--end::Input-->
                                                    <!--begin::Description-->
                                                ...
                                                <div class="mb-10 fv-row">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" name="previous_price" class="form-control mb-2" placeholder="Product price" value="{{ old('previous_price', $product->previous_price)}}"   />
                                                    <!--end::Input-->
                                                    <!--begin::Description-->
                                                    <!--end::Description-->
                                                </div>
