								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_63de8abe1e1bd">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_63de8abe1e1bd" data-allow-clear="true">
																<option></option>
											...
											<div class="card card-flush py-4 flex-row-fluid">
												...
												<div class="card-header">
													<div class="card-title">
														<h2>Order Details (#{{$order->number }})</h2>
													</div>
												</div>
												<!--end::Card header-->
												<!--begin::Card body-->
																			...
																			<div class="symbol symbol-circle symbol-25px overflow-hidden me-3">
																				<a href="../../demo1/dist/apps/ecommerce/customers/details.html">
																					<div class="symbol-label">
																						<img src="{{$order->user->image_path }}" alt="{{ $order->user->first_name .' '. $order->user->last_name }}" class="w-100" />
																					</div>
																				</a>
																			</div>
																			<!--end::Avatar-->
																			<!--begin::Name-->
																			<a href="../../demo1/dist/apps/ecommerce/customers/details.html" class="text-gray-600 text-hover-primary">{{ $order->user->first_name .' '. $order->user->last_name }}</a>
																			<!--end::Name-->
																		</div>
																	</td>
																</tr>
												...
												<div class="d-flex flex-column gap-7 gap-lg-10">
													<div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10">
														...
														<div class="card card-flush py-4 flex-row-fluid overflow-hidden">
															...
															<!--end::Card header-->
															<!--begin::Card body-->
															<div class="card-body pt-0">{{ $order->billing_phone }},
														...
														<div class="card card-flush py-4 flex-row-fluid overflow-hidden">
															...
															<!--end::Card header-->
															<!--begin::Card body-->
															<div class="card-body pt-0">{{ $order->shipping_phone }},
															<br />{{ $order->shipping_address }},
															<br />{{ $order->shipping_city }},
															<br />{{ $order->shipping_country }}.</div>
															<!--end::Card body-->
														</div>
																...
																<table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
																	...
																	<tbody class="fw-semibold text-gray-600">
                                                                        ...
                                                                        <tr>
																			...
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="symbol symbol-50px">
																						<span class="symbol-label" style="background-image: url('{{ $item->product->image_path }}');"></span>

																					</a>
																					<!--end::Thumbnail-->
																					<!--begin::Title-->
																					<div class="ms-5">
																						<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="fw-bold text-gray-600 text-hover-primary">{{ $item->product_name }}</a>
																						<div class="fs-7 text-muted">Delivery Date: 04/02/2023</div>
																					</div>
																					<!--end::Title-->
																				</div>
																			</td>
																			...
																			<!--end::Quantity-->
																			<!--begin::Price-->
																			<td class="text-end"><x-currency :amount="$item->price" /></td>
																			<!--end::Price-->
																			<!--begin::Total-->
																			<td class="text-end"><x-currency :amount="$item->price * $item->quantity " /></td>
																			<!--end::Total-->
																		</tr>
																		...
																		<tr>
																			...
																			<td class="text-dark fs-3 fw-bolder text-end"><x-currency :amount="$order->total" /></td>
																		</tr>
																		<!--end::Grand total-->
																	</tbody>
																	<!--end::Table head-->
