<x-layout-front>
    ...
    <div class="container py-5 rtl" style="text-align: left;">
        <h3 class="mb-3 text-center"> Shop Application</h3>
		@if ($errors->any())
	...
	@endif
        <form class="__shop-apply" action="{{ route('admin.register')}}" id="form-id" method="post"
                    ...
                    <div class="row g-3">
                        <div class="col-sm-6">
                            <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                name="fname" value="" placeholder="First name" required="">
                        </div>
                        <div class="col-sm-6">
                            <input type="text" class="form-control form-control-user" id="exampleLastName"
                                name="lname" value="" placeholder="Last name" required="">
                        </div>
                        <div class="col-sm-6 mt-4">
                            <input type="email" class="form-control form-control-user" id="exampleInputEmail"
                                name="email" value="" placeholder="Email address" required="">
                        </div>
                        <div class="col-sm-6"><small class="text-danger">( * Country code is must Like for BD 880
                                )</small>
                        ...
                        <div class="col-sm-6">
                            <input type="password" name="password_confirmation" class="form-control form-control-user" minlength="6"
                            ...
                            <center>
								...
								<div class="custom-file mt-3">
									<input type="file"   name="image" id="customFileUpload" class="custom-file-input"
										> 
									<label class="custom-file-label" for="customFileUpload">Upload Image</label> 
								</div> 
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-3">
                        <div class="col-sm-6 ">
                            <input type="text" class="form-control form-control-user" id="shop_name"
                                name="shop_name" placeholder="Shop name" value="" required="">
                        </div>
                        <div class="col-sm-6">
                            <textarea name="shop_desc" class="form-control" id="shop_address" rows="1" placeholder="Shop Description"></textarea>
                        </div>
                        <div class="col-sm-6">
                            <div class="pb-3">
                                <center>
                            ...
                            <div class="form-group mb-0">
                                <div class="custom-file">
                                    <input type="file" name="shop_logo" id="LogoUpload" class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label" for="LogoUpload">Upload Logo</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="custom-file">
                                    <input type="file" name="shop_cover" id="BannerUpload"
                                        class="custom-file-input overflow-hidden __p-2p"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label" for="BannerUpload">Upload Banner</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group mb-0 d-flex flex-wrap justify-content-between">
                                <label class="form-group mb-1 d-flex align-items-center">
                                    ...
                                    <span class="mb-4px d-block w-0 flex-grow pl-1">
                                        <span>I agree to Your terms</span>
                            ...
                            <div class="text-center">
                                <a class="small" href="https://6valley.6amtech.com/seller/auth/login">Already have an
                                    account login.</a>
                            </div>
                        </div>
                    </div>
