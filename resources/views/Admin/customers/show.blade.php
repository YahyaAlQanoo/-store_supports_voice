								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_63de8ac3a508e">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_63de8ac3a508e" data-allow-clear="true">
																<option></option>
												...
												<div class="card-body pt-15">
													...
													<div class="d-flex flex-center flex-column mb-5">
														...
														<div class="symbol symbol-150px symbol-circle mb-7">
															<img src="{{  $customer->image_path  }}" alt="image" />
														</div>
														<!--end::Avatar-->
														<!--begin::Name-->
													...
													<div class="pb-5 fs-6">
														...
														<div class="text-gray-600">
															<a href="#" class="text-gray-600 text-hover-primary">{{ $order->billing_email  }}</a>
														</div>
														<!--begin::Details item-->
														<!--begin::Details item-->
														<div class="fw-bold mt-5">Billing Address</div>
														<div class="text-gray-600">{{ $order->billing_address  }},
														<br />{{ $order->billing_city  }}
														<br />{{ $order->billing_country  }}</div>
														<!--begin::Details item-->
														<!--begin::Details item-->
															...
															<table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
																...
																<tbody class="fs-6 fw-semibold text-gray-600">
																	...
																	<tr>
																		<!--begin::order=-->
																		<td>
																			<a href="{{ route('orders.show',$order->id)}}" class="text-gray-600 text-hover-primary mb-1">#{{ $order->number }}</a>
																		</td>
																		<!--end::order=-->
																		<!--begin::Status=-->
																		<td>
																		...
																		<!--end::Amount=-->
																		<!--begin::Amount=-->
																		<td><x-currency :amount="$order->total" /></td>
																		<!--end::Amount=-->
																		<!--begin::Date=-->
												...
												<div class="tab-pane fade" id="kt_ecommerce_customer_general" role="tabpanel">
													...
													<div class="card pt-4 mb-6 mb-xl-9">
														...
														<div class="card-body pt-0 pb-5">
															...
															<!--begin::Form-->
															<form class="form" action="{{ route('customers.update',$customer->id) }}"   method="POST" id="kt_ecommerce_customer_profile" enctype="multipart/form-data">
																@csrf
																@method('put')
																...
																<div class="mb-7">
																	...
																	<div class="mt-1">
																		...
																		<div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
																			...
																			<div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{ $customer->image_path }}')"></div>
																...
																<div class="fv-row mb-7">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" class="form-control form-control-solid" placeholder="" name="name" value="{{ old('name',$customer->name)}}" />
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
																<!--begin::Row-->
																<div class="row row-cols-1 row-cols-md-2">
																	...
																	<div class="col">
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="email" class="form-control form-control-solid" placeholder="" name="email" value="{{ old('email',$customer->email)}}" />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																	</div>
																	...
																	<div class="col">
																		...
																		<div class="fv-row mb-7">
																			...
																			<!--end::Label-->
																			<!--begin::Input-->
																			<input type="text" class="form-control form-control-solid" placeholder="" name="phone" value="{{ old('phone',$customer->phone)}}" />
																			<!--end::Input-->
																		</div>
																		<!--end::Input group-->
																	</div>
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					...
																					<td class="text-gray-800">**** 1612</td>
																				</tr>
																				<tr>
																	...
																	<div class="d-flex flex-wrap py-5">
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Number</td>
																					<td class="text-gray-800">**** 3029</td>
																				</tr>
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Expires</td>
																	...
																	<div class="d-flex flex-wrap py-5">
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Number</td>
																					<td class="text-gray-800">**** 9712</td>
																				</tr>
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Expires</td>
