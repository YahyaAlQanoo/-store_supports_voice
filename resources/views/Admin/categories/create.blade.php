<x-layout-admin>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <form id="kt_ecommerce_add_category_form"   method="post" action="{{ route('categories.store')}}"  enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row">
                @csrf
                <!--begin::Aside column-->
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="category_name" class="form-control mb-2"
                                    placeholder="Product name" value="{{ old('category_name')}}" />
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div style="margin-bottom: 25px;">
                                ...
                                {{-- <div id="kt_ecommerce_add_category_description"
                                    ...
                                    <textarea name="description" class="form-control mb-2"   cols="30" rows="6">{{ old('description') }}</textarea>
                                <!--end::Editor-->
                                <!--begin::Description-->
